...
model.fit(reshaped_train,train_labels,validation_data=(reshaped_val,val_labels),epochs=train_epochs,batch_size=batchSize,callbacks=[csv_logger_1, checkpoint_0],verbose=1)
