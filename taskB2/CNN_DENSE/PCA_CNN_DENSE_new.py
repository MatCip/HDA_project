...
dense_layer_sizes = [64, 128, 512, 512, 1024]
...
for components, dense_layer_size in zip(n_components, dense_layer_sizes):
    ...
    scaled_train, scaled_val, scaled_test, train_labels, val_labels, test_labels = prepare_data(train_data, val_data, test_data, channels_by_variance[:components])
